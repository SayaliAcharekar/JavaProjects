...
public class Signup3 extends JFrame implements ActionListener {
    ...
    Signup3( String formno){
       ...
       r3=new JRadioButton("CurrentAccount");
       ...
       carddetails.setFont(new Font("Relway",Font.BOLD,12));
       carddetails.setBounds(100,330 , 300, 20);
       add(carddetails);
       
      
       JLabel pin =new JLabel("PIN:");
       pin.setFont(new Font("Relway",Font.BOLD,18));
       pin.setBounds(100,370 , 200, 30);
       add(pin);
       
       JLabel pnumber =new JLabel("XXXX");
       pnumber.setFont(new Font("Relway",Font.BOLD,18));
       pnumber.setBounds(330,370 , 300, 30);
       add(pnumber);
       
       
      JLabel pindetails =new JLabel("Your PIN");
       pindetails.setFont(new Font("Relway",Font.BOLD,12));
    ...
    public void actionPerformed(ActionEvent ae){
        if((ae.getSource()== submit)){
           ...
           if(c7.isSelected()){
               ...
               JOptionPane.showMessageDialog(null, "Please Select declaration box");
