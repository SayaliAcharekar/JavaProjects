...
public class Signup1 extends JFrame implements  ActionListener {
    ...
    long random;
    JTextField nameTextField,fnameTextField,eTextField,addTextField,cityTextField,stateTextField,pcodeTextField;
    JButton next;
    ...
    Signup1(){
        ...
        dobdate.setForeground(Color.BLACK);
        add(dobdate);
       ...
       JLabel e=new JLabel("Email:");
        ...
        eTextField.setFont(new Font("Raleway",Font.BOLD,20));
       ...
       add(cityTextField);
        ...
        pcodeTextField.setFont(new Font("Raleway",Font.BOLD,20));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try {
            if (name.equals("")){
               ...
               String query="insert into signup values('"+formno+"','"+name+"','"+fname+"','"+dob+"','"+gender+"','"+e+"','"+marital+"','"+add+"','"+city+"','"+state+"','"+pcode+"')";
